package com.rainclass.feature.homework.viewmodel
...
class HomeworkViewModel(
  ...
  fun loadDetail(cid: Long, leafId: Long) {
    viewModelScope.launch {
      ...
      val detailResult = repository.getDetails(cid, leafId)
      detailResult.fold(
        onSuccess = { detail ->
          val coverResult = repository.getCover(cid, detail.contentInfo.leafTypeId)
          coverResult.fold(
            onSuccess = { cover ->
